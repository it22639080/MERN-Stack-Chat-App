...
const LoginPage = () => {
  ...
  return (
    ...
    <h2 className='font-medium text-2xl flex justify-between items-center'>
      ...
      {
        currState === 'signup' && isDataSubmitted && (
          <textarea onChange={(e)=>setBio(e.target.value)} value={bio} rows={4} placeholder='enter bio' required className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' > </textarea>
        )
      }
